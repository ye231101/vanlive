...
import { Camera, ChevronLeft, ChevronRight, MapPin, Tag, Video } from 'lucide-react';
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
        ...
        <div className="flex items-baseline justify-between gap-3 text-lg font-bold">
          ...
          <span className="shrink-0 text-3xl font-black text-neutral-900 tabular-nums">
        ...
        <div className="mt-auto flex flex-col gap-2.5 pt-1">
          ...
          >
            SEE THIS VAN LIVE
            <Video className="size-4 shrink-0 text-white" strokeWidth={2} />
          </Button>
          <Button
            type="button"
            size="lg"
            variant="outline"
            className="w-full cursor-pointer items-center justify-center rounded-xl border-2 border-neutral-900 bg-white text-sm font-bold text-neutral-900 transition-colors hover:bg-neutral-50 hover:text-neutral-900"
          >
            GET BEST PRICE
